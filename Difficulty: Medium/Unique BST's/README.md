<h2><a href="https://www.geeksforgeeks.org/problems/unique-bsts-1587115621/1?page=1&category=Dynamic%20Programming,Graph&difficulty=Easy,Medium,Hard&status=unsolved&sortBy=submissions">Unique BST's</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an integer. Find how many <strong>structurally unique binary search trees </strong>are there that stores the&nbsp;values from 1 to that integer (inclusive).&nbsp;</span></p>
