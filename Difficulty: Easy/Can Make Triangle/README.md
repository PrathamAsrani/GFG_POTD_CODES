<h2><a href="https://www.geeksforgeeks.org/problems/can-make-triangle--170637/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Can Make Triangle</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array&nbsp;<strong>A[]&nbsp;</strong>of&nbsp;<strong>N&nbsp;</strong>elements, You'd like to know how many triangles can be formed with side lengths equal to adjacent elements from A[].</span></p>
